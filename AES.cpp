...
void AES::KeyExpantionCore(unsigned char* in, unsigned char iteration)
{
...
void AES::KeyExpansion(unsigned char* inputKey, unsigned char* expandedKeys) {
    ...
    while(bytesGenerated < 176) {
        ...
        for (unsigned char a : temp) {
            expandedKeys[bytesGenerated] = expandedKeys[bytesGenerated - 16] ^ a;
            bytesGenerated++;
        }
    }
...
const unsigned char AES::multiplyBy2[] =
{
...
//Galois multiplication lookup tables
const unsigned char AES::multiplyBy3[] =
{
